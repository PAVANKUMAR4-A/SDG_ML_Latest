...
Bulk_data_config_file = pd.read_excel(r'D:\Users\pavankumar4\PycharmProjects\SDG_ML_Vamsi_1.3\BULK_CONFIG_FILE\Engagement_training_config_file.xlsx.xlsx',sheet_name='SDV_BULK')
Bulk_pickle_file_locations = pd.read_excel(r'D:\Users\pavankumar4\PycharmProjects\SDG_ML_Vamsi_1.3\BULK_CONFIG_FILE\Engagement_training_config_file.xlsx.xlsx',sheet_name='BULK_Pickle_file_locations')
TXT_words = pd.read_excel(r'D:\Users\pavankumar4\PycharmProjects\SDG_ML_Vamsi_1.3\BULK_CONFIG_FILE\Engagement_training_config_file.xlsx.xlsx',sheet_name='TXT_words')
